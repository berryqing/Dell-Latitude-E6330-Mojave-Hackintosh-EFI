 ...
 *
 * Disassembly of DSDT.aml, Tue May  7 04:54:35 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000A51C (42268)
 *     Revision         0x02
 *     Checksum         0x65
 *     OEM ID           "DELL  "
 *     OEM Table ID     "CBX3   "
...
DefinitionBlock ("", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000021)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xD87FDE18, 0x01D3)
    ...
    OperationRegion (EXBU, SystemMemory, 0xD87FFF18, 0x000D)
...
If (PM0H)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDA066E18, 0x10)
    ...
    Scope (_GPE)
    {
        ...
        {
            If (LNotEqual (\_SB.PCI0.VID.SCIP (), Zero))
            {
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (PS2K)
        {
            Name (_HID, "DLLK0533")  // _HID: Hardware ID
        ...
        Device (PS2M)
        {
            Name (_HID, EisaId ("DLL0533"))  // _HID: Hardware ID
